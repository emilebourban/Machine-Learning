...
#        poly_data_tr = imp.build_poly(data, degree[i])
##        poly_data_te = imp.build_poly(data_te, degree[i])
#        w_poly, loss_poly = imp.least_squares(y_tr[i], poly_data_tr[i])
#        print(loss_poly)
#        acc_poly = imp.calculate_accuracy(poly_data_te[0], y_te[0], w_poly)
#        print("accuracy w/ degree", degree[i],acc_off)
#
